...
// ==========================================
// 9. INLINE CALLBACK HANDLER (SMART BOX SWITCHING)
// ==========================================
bot.on('callback_query', async (query) => {
    ...
    const switchMenu = async (newText, newKeyboard) => {
        try {
...
┣━━━━━━━━━━━━━━━━━━━━━
┃ 👑 <b>Owner:</b> ${_0xBrand}
┃ 👤 <b>User:</b> @${query.from.username || 'User'}
┃ 💎 <b>Premium:</b> ${isPremium(userId) ? 'Yes ✅' : 'No ❌'}
┣━━━━━━━━━━━━━━━━━━━━━
┃ 📺 <b>YouTube:</b> <a href="${_0xYT}">Subscribe</a>
┃ ✈️ <b>Telegram:</b> <a href="${_0xTG}">Join Us</a>
...
<i>Select a menu category below:</i>`;
        ...
        const mainKeyboard = {
            inline_keyboard: [
                [{ text: "📱 WA Menu", callback_data: "wa_menu" }, { text: "📥 DL Menu", callback_data: "dl_menu" }],
                [{ text: "⚙️ Owner Menu", callback_data: "owner_menu" }, { text: "📋 Help", callback_data: "help_menu" }],
                [{ text: "👤 Contact Developer", url: "https://t.me/Dev_Null_X" }]
            ]
        };
        await switchMenu(welcomeText, mainKeyboard);
    }

    // --- WHATSAPP BOX ---
    else if (data === "wa_menu") {
        const waText = `┏━━━━━━━━━━━━━━━━━━━━━
┃ 📱 <b>WHATSAPP MENU</b>
┣━━━━━━━━━━━━━━━━━━━━━
┃ 🔸 <code>/pair 91xxx</code> - Link Device
┃ 🔸 <code>/delpair 91xxx</code> - Unlink
┃ 🔸 <code>/listsessions</code> - Active Pairs
┃ 🔸 <code>/listpaired</code> - All Sessions
┗━━━━━━━━━━━━━━━━━━━━━
<i>Tap a command to copy!</i>`;
        await switchMenu(waText, { inline_keyboard: backBtn });
    }
...
┃ 📥 <b>DOWNLOAD MENU</b>
┣━━━━━━━━━━━━━━━━━━━━━
┃ 🔸 <code>/ig [link]</code> - Instagram DL
┃ 🔸 <code>/yt [link]</code> - YouTube Direct
┃ 🔸 <code>/ytmp3 [link]</code> - YT Audio
┃ 🔸 <code>/ytmp4 [link]</code> - YT Video
┗━━━━━━━━━━━━━━━━━━━━━
<i>Fast & Background Downloading!</i>`;
        await switchMenu(dlText, { inline_keyboard: backBtn });
    }

    // --- OWNER BOX ---
    else if (data === "owner_menu") {
        if (!isOwner(userId)) return bot.answerCallbackQuery(query.id, { text: "❌ Access Denied! Owner Only.", show_alert: true });
        const ownerText = `┏━━━━━━━━━━━━━━━━━━━━━
┃ ⚙️ <b>OWNER PANEL</b>
┣━━━━━━━━━━━━━━━━━━━━━
┃ 🔸 <code>/addprem [id]</code> - Add VIP
┃ 🔸 <code>/delprem [id]</code> - Remove VIP
┃ 🔸 <code>/premium on/off</code> - VIP Mode
┃ 🔸 <code>/public on/off</code> - Public Mode
┃ 🔸 <code>/self on/off</code> - Self Mode
┗━━━━━━━━━━━━━━━━━━━━━`;
        await switchMenu(ownerText, { inline_keyboard: backBtn });
    }
...
┃ • Stay joined in our channels
┃ • For support: @Dev_Null_X
┗━━━━━━━━━━━━━━━━━━━━━`;
        await switchMenu(helpText, { inline_keyboard: backBtn });
    }

    // 🔥 KEEP THE YT DOWNLOADER LOGIC HERE
    else if (data.startsWith("dl_mp3_") || data.startsWith("dl_mp4_")) {
        // ... (Tumhara pichla background downloader wala code yahan rehne do)
    }
});
