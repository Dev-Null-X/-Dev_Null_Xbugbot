/* ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  🚀 SYSTEM VALIDATOR ENGINE (PRO V6)
...
const bannerText = `
═══════════════════════════════════════
   🚀 SYSTEM CHECKER BY ${_0xBrand}
   📺 YouTube: ${_0xYT}
   ✈️ Telegram: ${_0xTG}
═══════════════════════════════════════\n`;

// 🛡️ COPYRIGHT INTEGRITY CHECK (Crashes if credits are modified)
if (!bannerText.includes(_0xBrand) || !bannerText.includes("Dev_Null_X")) {
...
console.log('\n═══════════════════════════════════════');
if (allPassed) {
  console.log(`✅ All Validation Checks Passed! (${_0xBrand})`);
  console.log('═══════════════════════════════════════');
